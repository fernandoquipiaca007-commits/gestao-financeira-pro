        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 overflow-y-auto flex-1">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 bg-white border border-slate-300 rounded-xl text-slate-900 text-xs font-bold focus:outline-none focus:border-teal-500"
            >
              {clients.map((c) => (
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-white border border-slate-300 rounded-xl text-slate-900 text-xs font-bold focus:outline-none focus:border-teal-500 placeholder-slate-400"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-emerald-700 font-black text-sm focus:outline-none focus:border-teal-500"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-xs font-bold focus:outline-none focus:border-teal-500"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-slate-900 text-xs font-black focus:outline-none focus:border-teal-500"
              >
          ...
          <div className="pt-3 border-t border-slate-200 flex items-center justify-end space-x-3">
            ...
            <button
              type="submit"
              className="px-5 py-2.5 bg-teal-600 hover:bg-teal-700 text-white font-bold text-xs rounded-xl flex items-center space-x-2 transition-all shadow-xs cursor-pointer active:scale-95"
            >
